...
<head>
    ...
    <title>Tambah Beban Operasional - Oriya Herbal Sejahtera</title>
    ...
    <div class="flex h-screen overflow-hidden">
        ...
        <div class="flex-1 flex flex-col overflow-hidden">
            ...
            <main class="flex-1 overflow-y-auto bg-white p-6">
                <div class="max-w-2xl">
                    <h2 class="text-3xl font-bold text-[#2d5016] mb-6">Tambah Beban Operasional</h2>
                    ...
                    <form action="{{ route('beban-operasional.store') }}" method="POST" class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
                        @csrf
                            ...
                            <select name="kode_akun" id="kode_akun" onchange="updateNamaAkun()"
                                ...
                                @foreach($coas as $coa)
                                    <option value="{{ $coa->kode_akun }}" data-nama-akun="{{ $coa->nama_akun }}"
                                        {{ old('kode_akun') == $coa->kode_akun ? 'selected' : '' }}>
                        ...
                        <div class="mb-4">
                            ...
                            <input type="number" name="nominal" id="nominal" value="{{ old('nominal') }}" step="0.01" min="0"
                                class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#90EE90] focus:border-transparent" 
                                required>
                        </div>
                        ...
                        <div class="mb-6">
                            ...
                            <input type="date" name="tanggal_pengeluaran" id="tanggal_pengeluaran" value="{{ old('tanggal_pengeluaran') }}" 
                                class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#90EE90] focus:border-transparent" 
                                required>
                        </div>
