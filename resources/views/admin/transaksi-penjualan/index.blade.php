                ...
                <ul class="space-y-1">
                    ...
                    <li>
                        <button onclick="toggleDropdown('transaksi')" class="w-full flex items-center justify-between px-4 py-3 text-[#2d5016] hover:bg-[#D0F0D0] rounded-lg transition duration-200">
                            ...
                            <svg id="transaksi-icon" class="w-4 h-4 transition-transform duration-200 rotate-180" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"></path>
                            </svg>
                        </button>
                        <ul id="transaksi" class="mt-1 ml-8 space-y-1">
                            <li>
                                <a href="{{ route('admin.transaksi-penjualan.index') }}" class="block px-4 py-2 text-sm bg-[#90EE90] text-[#2d5016] rounded-lg font-semibold">Penjualan</a>
                            </li>
                            <li>
                    ...
                    <li>
                        ...
                        <ul id="laporan" class="hidden mt-1 ml-8 space-y-1">
                            ...
                            <li><a href="{{ route('buku-besar.index') }}" class="block px-4 py-2 text-sm text-[#2d5016] hover:bg-[#D0F0D0] rounded-lg transition duration-200">Buku Besar</a></li>
                    ...
                    <table class="min-w-full divide-y divide-gray-200">
                        <thead class="bg-[#E8F5E9]">
                            <tr>
                                ...
                                <th class="px-6 py-3 text-left text-xs font-medium text-[#2d5016] uppercase tracking-wider">Kasir</th>
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            @forelse($transaksis as $transaksi)
                                <tr>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">{{ $transaksi->no_hp ?? '-' }}</td>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm">
                                        <a href="{{ route('bukti-nota.show', $transaksi->id) }}" class="text-[#2d5016] hover:text-[#1a3009] mr-3">Lihat Nota</a>
