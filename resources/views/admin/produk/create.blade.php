...
<head>
    ...
    <title>Tambah Produk - Oriya Herbal Sejahtera</title>
    ...
    <div class="flex h-screen overflow-hidden">
        ...
        <div class="flex-1 flex flex-col overflow-hidden">
            ...
            <main class="flex-1 overflow-y-auto bg-white p-6">
                <div class="max-w-2xl">
                    <h2 class="text-3xl font-bold text-[#2d5016] mb-6">Tambah Produk</h2>
                    ...
                    <form action="{{ route('produk.store') }}" method="POST" class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
                        @csrf
                        ...
                        <div class="mb-4">
                            ...
                            <input type="number" name="harga_jual" id="harga_jual" value="{{ old('harga_jual') }}" step="0.01" min="0"
                                class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#90EE90] focus:border-transparent" 
                                required>
                        </div>
                        ...
                        <div class="mb-6">
                            ...
                            <input type="number" name="harga_beli" id="harga_beli" value="{{ old('harga_beli') }}" step="0.01" min="0"
                                class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#90EE90] focus:border-transparent">
                        </div>
