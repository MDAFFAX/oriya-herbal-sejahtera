...
<head>
    ...
    <title>Edit Pelanggan - Oriya Herbal Sejahtera</title>
    ...
    <div class="flex h-screen overflow-hidden">
        ...
        <div class="flex-1 flex flex-col overflow-hidden">
            ...
            <main class="flex-1 overflow-y-auto bg-white p-6">
                <div class="max-w-2xl">
                    <h2 class="text-3xl font-bold text-[#2d5016] mb-6">Edit Pelanggan</h2>
                    ...
                    <form action="{{ route('pelanggan.update', $pelanggan->id) }}" method="POST" class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="flex items-center gap-4">
                            ...
                            <a href="{{ route('pelanggan.index') }}" class="bg-gray-200 hover:bg-gray-300 text-gray-700 px-6 py-2 rounded-lg font-semibold transition duration-200">
                                Batal
                            </a>
                        </div>
                    </form>
