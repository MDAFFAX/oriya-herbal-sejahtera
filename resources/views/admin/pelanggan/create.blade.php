...
<head>
    ...
    <title>Tambah Pelanggan - Oriya Herbal Sejahtera</title>
    ...
    <div class="flex h-screen overflow-hidden">
        ...
        <div class="flex-1 flex flex-col overflow-hidden">
            ...
            <main class="flex-1 overflow-y-auto bg-white p-6">
                <div class="max-w-2xl">
                    <h2 class="text-3xl font-bold text-[#2d5016] mb-6">Tambah Pelanggan</h2>
                    ...
                    <form action="{{ route('pelanggan.store') }}" method="POST" class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
                        @csrf
