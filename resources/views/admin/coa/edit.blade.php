...
<head>
    ...
    <title>Edit Akun COA - Oriya Herbal Sejahtera</title>
    ...
    <div class="flex h-screen overflow-hidden">
        ...
        <div class="flex-1 flex flex-col overflow-hidden">
            ...
            <main class="flex-1 overflow-y-auto bg-white p-6">
                <div class="max-w-2xl">
                    <h2 class="text-3xl font-bold text-[#2d5016] mb-6">Edit Akun COA</h2>
                    ...
                    <form action="{{ route('coa.update', $coa->id) }}" method="POST" class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
                        @csrf
                        @method('PUT')

                        <div class="mb-4">
                            <label for="kode_akun" class="block text-sm font-medium text-gray-700 mb-2">Kode Akun</label>
                            <input type="text" name="kode_akun" id="kode_akun" value="{{ old('kode_akun', $coa->kode_akun) }}" 
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="nama_akun" id="nama_akun" value="{{ old('nama_akun', $coa->nama_akun) }}" 
                                class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#90EE90] focus:border-transparent" 
                                required>
                        </div>
                        ...
                        <div class="mb-6">
                            ...
                            <input type="text" name="header_akun" id="header_akun" value="{{ old('header_akun', $coa->header_akun) }}" 
                                class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#90EE90] focus:border-transparent" 
                                required>
                        </div>
